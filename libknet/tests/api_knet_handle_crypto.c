...
static void test(const char *model, const char *model2)
{
	...
	log_test(logfd, "Test knet_handle_crypto with invalid cfg");

	FAIL_ON_SUCCESS(knet_handle_crypto(knet_h1, NULL), EINVAL);

	log_test(logfd, "Test knet_handle_crypto with un-initialized cfg");

	FAIL_ON_SUCCESS(knet_handle_crypto(knet_h1, &knet_handle_crypto_cfg), EINVAL);

	log_test(logfd, "Test knet_handle_crypto with none crypto model (disable crypto)");
	...
	log_test(logfd, "Test knet_handle_crypto with none crypto cipher and hash (disable crypto)");
	...
	log_test(logfd, "Test knet_handle_crypto with %s/aes128/sha1 and too short key", model);
	...
	log_test(logfd, "Test knet_handle_crypto with %s/aes128/sha1 and too long key", model);
	...
	log_test(logfd, "Test knet_handle_crypto with %s/aes128/sha1 and normal key", model);
	...
	log_test(logfd, "Test knet_handle_crypto reconfig with %s/aes128/sha1 and normal key", model2);
	...
	log_test(logfd, "Test knet_handle_crypto with %s/aes128/sha1 and key where (key_len %% wrap_key_block_size != 0)", model);
